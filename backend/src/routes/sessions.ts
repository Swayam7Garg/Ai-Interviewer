...
export default async function sessionRoutes(fastify: FastifyInstance) {
  ...
  fastify.post('/:id/answer', async (request, reply) => {
    ...
    const aiFeedbackJson = {
      ...
      idealAnswerSkeleton: scoreData.ideal_answer_skeleton,       // legacy field kept for compat
      idealAnswerOutline: scoreData.ideal_answer_outline,
      whatWasCorrect: scoreData.what_was_correct || [],
      technicalErrors: scoreData.technical_errors || [],
      keyConceptsMissed: scoreData.key_concepts_missed || [],
      interviewerCorrection: scoreData.interviewer_correction || '',
    };
