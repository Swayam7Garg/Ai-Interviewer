...
class ScoreAnswerResponse(BaseModel):
    ...
    ideal_answer_skeleton: Optional[str] = ""
    ideal_answer_outline: Optional[str] = ""
    what_was_correct: Optional[List[str]] = []
    technical_errors: Optional[List[str]] = []
    key_concepts_missed: Optional[List[str]] = []
    interviewer_correction: Optional[str] = ""
